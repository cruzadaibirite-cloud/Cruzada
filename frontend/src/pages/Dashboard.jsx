              ...
              {papelNoGrupo === 'admin' ? (
                <div style={{ display: 'flex', marginTop: '12px', border: '1.5px solid #e5e7eb', borderRadius: '12px', overflow: 'hidden', background: '#fff', alignItems: 'flex-end' }}>
                  <textarea
                    ...
                    onKeyDown={e => { if (e.key === 'Enter' && e.ctrlKey) { e.preventDefault(); enviarMensagem() } }}
                  ...
                  />
                  <button onClick={() => { enviarMensagem(); if (chatInputRef.current) { chatInputRef.current.style.height = 'auto' } }} disabled={enviandoMensagem || !novaMensagem.trim()} style={{ background: '#F97310', border: 'none', borderRadius: '0', width: '46px', alignSelf: 'stretch', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', flexShrink: 0, opacity: 1 }}>
                ...
                {editando ? (
                  ...
                  <>
                    ...
                    <div style={{ display: 'flex', gap: '8px', marginLeft: 'auto' }}>
                      {selected?.usuario_id && (
                        <button style={{ ...s.editBtn, background: '#f0f9ff', color: '#0ea5e9', borderColor: '#0ea5e9' }} onClick={() => navigate(`/sistema/usuarios/${selected.usuario_id}`)}>Usuário</button>
                      )}
                ...
                <div style={s.formGrid} className="dash-form-grid">
                  {editando ? (
                    ...
                    <>
                      ...
                      <div>
                        <label style={{ display: 'block', fontSize: '13px', fontWeight: 700, color: '#6b7280', marginBottom: '6px' }}>WhatsApp</label>
                        {selected.whatsapp ? (
                          <a href={`https://wa.me/55${selected.whatsapp.replace(/\D/g,'')}`} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '8px', width: '100%', padding: '10px 14px', border: '1.5px solid #25d366', borderRadius: '8px', fontSize: '14px', fontWeight: 700, color: '#25d366', background: '#f0fdf4', boxSizing: 'border-box', textDecoration: 'none', cursor: 'pointer' }}>
                          ...
                          <div style={{ width: '100%', padding: '10px 14px', border: '1.5px solid #e5e7eb', borderRadius: '8px', fontSize: '14px', color: '#0f1117', background: '#f9fafb', boxSizing: 'border-box' }}>—</div>
                        )}
                      </div>
                      <div>
                        <label style={{ display: 'block', fontSize: '13px', fontWeight: 700, color: '#6b7280', marginBottom: '6px' }}>Instagram</label>
                        {selected.instagram ? (
                          <a href={`https://instagram.com/${selected.instagram.replace(/^@/,'')}`} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '8px', width: '100%', padding: '10px 14px', border: '1.5px solid #e1306c', borderRadius: '8px', fontSize: '14px', fontWeight: 700, color: '#e1306c', background: '#fff0f5', boxSizing: 'border-box', textDecoration: 'none', cursor: 'pointer' }}>
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#e1306c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
                            {selected.instagram}
                          </a>
                        ) : (
                          <div style={{ width: '100%', padding: '10px 14px', border: '1.5px solid #e5e7eb', borderRadius: '8px', fontSize: '14px', color: '#0f1117', background: '#f9fafb', boxSizing: 'border-box' }}>—</div>
